...
const Divider = ({ variant }) => {
    return React.createElement(Divider$1, { variant: variant });
};
...
const Snackbar = (props) => {
    ...
    return (React.createElement(Snackbar$1, { anchorOrigin: anchorOrigin, autoHideDuration: autoHideDuration, classes: classes, key: key, onClose: onClose, open: open, TransitionComponent: TransitionComponent, action: action, ...rest }, children));
};

const SnackbarContent = (props) => {
    const { classes, role, color, action, message } = props;
    return (React.createElement(SnackbarContent$1, { classes: classes, role: role, color: color, action: action, message: message }));
};

export { AppBar, AppBarHighlight, Avatar, Badge, Button, Card, Checkbox, Chip, Container, Counter, CssBaseline, DialogWrapper, Divider, ErrorWrapper, ExpansionPanel, ExpansionPanelDetails, ExpansionPanelSummary, HorizontalSpace, Icon, IconButton, Image, Input, Link, List, ListItem, ListItemAvatar, ListItemIcon, ListItemSecondaryAction, ListItemText, ListSubheader, Logo, Popover, ProgressIndicator, Provider, Radio, Rating, Skeleton, Snackbar, SnackbarContent, TabContainer, TabItem, Text, TextField, ToggleButton, Toolbar, View, themes };
