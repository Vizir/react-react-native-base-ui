...
import { Button as Button$1, Typography, Card as Card$1, TextField as TextField$1, ProgressIndicator as ProgressIndicator$1 } from '@naturacosmeticos/natds-web';
...
const ErrorWrapper = (props) => {
    ...
    return (React.createElement(ContainerWrapper, null,
        ...
        textButton && (React.createElement(LinkButton, null,
            React.createElement(Button$1, { color: "primary", variant: "outlined", onClick: actionButton, size: "large" }, textButton)))));
};
...
export { Button, Card, ErrorWrapper, HorizontalSpace, ProgressIndicator, Text, TextField, View };
